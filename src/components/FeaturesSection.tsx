...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Powerful <span className="text-gradient">Dashboard Features</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            <div 
              key={feature.id}
              className="group bg-white rounded-2xl shadow-sm p-8 transition-all duration-300 hover:shadow-lg border border-gray-100 hover:border-blue-200/50 hover:-translate-y-1 opacity-0 animate-fade-in cursor-pointer"
              style={{ animationDelay: `${index * 150}ms` }}
              onClick={showSignupPrompt}
            >
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl flex items-center justify-center text-blue-600 mb-6 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
              <h3 className="text-xl font-semibold mb-4 text-gray-900">{feature.name}</h3>
        ...
        {/* Dashboard Preview */}
        <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100 opacity-0 animate-fade-in animate-delay-700">
          <h3 className="text-3xl font-bold mb-10 text-center text-gray-900">Dashboard for Every Role</h3>
