...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ 
      ...
      items: [
        {
          ...
          icon: UserCheck,
          href: "/admin/drivers",
          badge: activeDrivers > 0 ? { text: activeDrivers.toString(), variant: "success" } : null
        },
        {
          ...
          badge: activeDrivers > 0 ? { text: "Live", variant: "success", pulse: true } : null
        },
        {
          id: "orders",
          ...
          icon: FileText,
          href: "/admin/orders",
          badge: pendingOrders > 0 ? { text: pendingOrders.toString(), variant: "warning" } : null
        },
        {
          id: "fleet",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          badge: activeOrders > 0 ?  { text: activeOrders.toString(), variant: "info" } : null
        }
      ]
    },
    {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 left-0 z-40 h-full bg-white/95 backdrop-blur-xl border-r border-gray-200/60 shadow-2xl transition-all duration-300 ease-in-out",
      ...
      >
                      ...
                      {!collapsed && (
                        <>
                          ...
                          {item.badge && (
                            <Badge 
                              className={cn(
                                "ml-2 text-xs px-2 py-0.5 border",
                                getBadgeVariant(item.badge.variant || "default"),
        ...
        <div className="border-t border-gray-200/50 p-4">
          <Button 
            variant="outline" 
            className={cn(
              "w-full bg-gradient-to-r from-red-500 to-rose-500 text-white border-none hover:from-red-600 hover:to-rose-600 shadow-lg hover:shadow-xl transition-all duration-200",
              collapsed ? "px-2" : "px-4"
            )}
      ...
      >
        ...
        <div className="border-t border-gray-200/50 p-4">
          <Button 
            variant="outline" 
            className="w-full bg-gradient-to-r from-red-500 to-rose-500 text-white border-none hover:from-red-600 hover:to-rose-600 shadow-lg"
          >
